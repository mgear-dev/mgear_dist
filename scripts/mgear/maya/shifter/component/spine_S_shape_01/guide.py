...
from mgear.maya import transform, pyqt, vector
...
class Guide(guide.ComponentGuide):
    ...
    def addObjects(self):
        ...
        # tangent handles
        self.disp_tancrv0 = self.addDispCurve("crv", [self.root, self.tan0])
        self.disp_tancrv1 = self.addDispCurve("crv", [self.eff, self.tan1])
